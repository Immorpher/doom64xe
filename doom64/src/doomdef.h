...
#define LASTLEVEL 102 // End of normal levels
...
void wess_master_sfx_vol_set(char volume);
void wess_master_mus_vol_set(char volume);
...
void I_Error(char *error, ...) COLD; // 80005F30
...
#define ALL_FORWARD     (PAD_RIGHT|PAD_R_TRIG|PAD_UP_C|PAD_RIGHT_C|PAD_A)
#define ALL_BACK		(PAD_LEFT|PAD_L_TRIG|PAD_DOWN_C|PAD_LEFT_C|PAD_B|PAD_Z_TRIG)
